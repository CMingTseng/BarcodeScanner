...
//
///**
// * Created by Neo on 2016/9/8 008.
// */
...
//		final View root = inflater.inflate(R.layout.capture, container, false);
...
//		SurfaceView surfaceView = (SurfaceView) getView().findViewById(R.id.capture_preview_view); // 预览
...
//		if (!hasSurface) {
//			SurfaceView surfaceView = (SurfaceView) getView().findViewById(R.id.capture_preview_view);
//			SurfaceHolder surfaceHolder = surfaceView.getHolder();
...
//
//		Toast.makeText(getActivity(), "识别结果:" + ResultParser.parseResult(rawResult).toString(), Toast.LENGTH_SHORT).show();
//
//	}
//
...
//			// RuntimeException.
//			if (handler == null) {
//				handler = new CaptureActivityHandler(getActivity(), decodeFormats, decodeHints, characterSet, cameraManager);
//			}
