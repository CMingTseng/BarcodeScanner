...
//
////        mViewfinderView = (ViewfinderView) getView().findViewById(R.id.capture_viewfinder_view);
...
////    SurfaceView mSurfaceView = (SurfaceView) findViewById(R.id.capture_preview_view); // 預覽
...
////    }
//
////        TextureView mSurfaceView = (TextureView) getView().findViewById(R.id.capture_preview_view); // 預覽
