 ...
 */
public final class OpenCameraInterface_G {

    private static final String TAG = OpenCameraInterface_G.class.getName();

    private OpenCameraInterface_G() {
    }
     ...
     *                 #NO_REQUESTED_CAMERA} means "no preference", in which case a rear-facing
